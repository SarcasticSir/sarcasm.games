document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderCard(cardData) {
        ...
        if (cardData.req !== undefined) { // Storm Card
            ...
            if (disabledCardTypes[cardData.type]) {
    ...
    function selectCard(cardEl, cardData) {
        // Prevent selecting cards of a disabled type
        if (disabledCardTypes[cardData.type]) {
            return;
        }
    ...
    function resolveTurn(didPlayCards) {
        ...
        setTimeout(() => {
            // Reset disabled types for the new turn
            disabledCardTypes = {};
            drawStormCard();
            renderPlayerHand();
        }, 1000);
    ...
    function handleAftermath(stormCardId) {
        switch(stormCardId) {
            ...
            case 's25':
                ...
                break;
            case 's8':
                disabledCardTypes['FOCUS'] = true;
                break;
            case 's36':
                disabledCardTypes['FOCUS'] = true;
                disabledCardTypes['RESILIENCE'] = true;
                break;
            case 's68':
                disabledCardTypes['MAINTENANCE'] = true;
                break;
